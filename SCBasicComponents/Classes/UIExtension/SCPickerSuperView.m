...
{
    if (self.doCancelButtonBlock) {
        self.doCancelButtonBlock(self);
    }
}

-(void)doFinish:(id)sender
{
    if (self.doFinishButtonBlock) {
        self.doFinishButtonBlock(self);
    }
}
...
-(void)touchedBackground:(id)sender
{
    ...
    if (self.touchBackgroundBlock) {
        self.touchBackgroundBlock(self);
    }
}
