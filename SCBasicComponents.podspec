...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SCBasicComponents.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wenkun/SCBasicComponents'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wenkun' => 'ken.bug@qq.com' }
  s.source           = { :git => 'https://github.com/wenkun/SCBasicComponents.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'SCBasicComponents/Classes/**/*'
